...
class Test(models.Model):
    ...
    code = models.CharField(max_length=5, default=helpers.random_code, verbose_name="Код", unique=True)
...
class Question(models.Model):
    ...
    test = models.ForeignKey(Test, verbose_name="Тест", null = True, on_delete=models.CASCADE)
